    ...
    <body class="bg-light">
        ...
        <main class="main bg-light text-secondary">
            ...
            <div class="container coins main-contets">
                    <div class="contents">
                        <h2 class="title text-danger"><?php print $username;?></h2>
                ...
                <div class="container coins sub-contents">
                    <div class="info">
                        <h2 class="text-dark">保有コイン</h2>
                        <h2 class="select"><a href="mypage_bought.php">購入履歴</a></h2>
                    ...
                    <?php if(count($mydata) !== 0){?>
                     <table class="table">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <th scope="row"><?php print $value['name'];?></th>
                          <td><?php print $value['have'];?></td>
                          <td><?php print $value['price'];?></td>
                          <td><?php print $value['price']*$value['have'];?></td>
                          <td>
                              <form method = "post">
                                    <input  class="btn btn-primary btn-lg btn-block" type="submit" name="sell" value="売却">
                                    <input type="hidden" name="sell_id" value="<?php print $value['id'];?>">
                                </form>
                          </td>
                        </tr>
                        <?php } ?>
