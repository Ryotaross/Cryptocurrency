            ...
            <div class="container coins main-contets">
                ...
                <div class="container coins sub-contents">
                   <div class="info">
                        ...
                        <h2 class="text-dark select">売却履歴</h2>
                    </div>
                <?php if(count($data_sold) !== 0){?>
                    <table class="table">
                      <thead>
                        <tr>
                          <th scope="col">売却日時</th>
                          <th scope="col">売却商品</th>
                          <th scope="col">売却数</th>
                          <th scope="col">売却価格</th>
                          <th scope="col">合計価格</th>
                        </tr>
                      </thead>
                      <tbody>
                          <?php foreach($data_sold as $key => $value){?>
                        <tr>
                ...
                <?php }else { ?>
                    <div style="text-align:center;margin:auto 0;">
                        <h1 style="margin-top:100px;margin-bottom:30px">売却履歴はございません</h1>
                    </div>
                <?php } ?>
            </div>   
        </main>
